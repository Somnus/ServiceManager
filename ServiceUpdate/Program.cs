...
namespace ServiceUpdate
{
    class Program
    {
        ...
        {
            {
                string srcFileName = @"C:\Users\somnus\Desktop\0926面试记录.txt";
                string zipFileName = @"C:\Users\somnus\Desktop\0926面试记录.zip";
                string unzipFileName = @"C:\Users\somnus\Desktop\0926面试记录1.txt";
                {
            ...
            {
                //string srcFileName = @"C:\Users\somnus\Desktop\test";
                //string zipFileName = @"C:\Users\somnus\Desktop\test.zip";
                //string unzipFileName = @"C:\Users\somnus\Desktop\test1.zip";

                //using (BZip2OutputStream zos = new BZip2OutputStream(File.Open(zipFileName, FileMode.Create)))
                //{
                //    foreach (string file in Directory.GetFiles(srcFileName))
                //    {
                //        if (File.Exists(file))
                //        {
